...
/**
  * @brief Esta función inicializa un puerto UDP que va a ser usado por un cliente.
  * @param None
  * @retval None
  */
...
/**
  * @brief Esta función realiza el envío de un mensaje de texto a la dirección IP y Nro de puerto indicado.
  * @param Dirección IPV4 de destino
